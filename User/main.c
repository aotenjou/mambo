...
/***************************************************************************************
  * 本程序根据博主Sngels_wyh创建，由博主呱瓜乐修改，并免费开源共享
  * 你可以任意查看、使用和修改，并应用到自己的项目之中
  * 
  * 程序名称：				基于STM32F103C8T6单片机的桌面宠物小项目
  * 此程序更新时间：			2026.3.23
  * 
  * 主要在立创开源平台、哔哩哔哩、抖音分享自己的作品。
	*	相关的资料可以去立创开源硬件平台网站上搜索,作品附件放置更新网盘，如有更新可方便快速查看
	* 地址:https://oshwhub.com/guasses/stm32-zhi-neng-zhuo-mian-chong-wu-zhong-zhi
  ***************************************************************************************/
...
int main(void)
{
	...
	{	
		...
		if(pinState == Bit_SET)
		{
			GPIO_ResetBits(GPIOA, GPIO_Pin_4); //PA4输出低电平
		}else
		{
			GPIO_SetBits(GPIOA, GPIO_Pin_4);   //PA4输出高电平
		}
